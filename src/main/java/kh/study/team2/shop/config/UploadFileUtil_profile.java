...
//	private static final String UPLOAD_PATH = "C:\\Users\\202-30\\git\\PotatoShop\\src\\main\\resources\\static\\images\\";
	...
	//파일 첨부
	public static ProfileVO uploadFile(MultipartFile profileImg) {
		String originFileName = null;
		String fileName = null;
		
		//실제 첨부 파일이 있을 때만 첨부 기능 실행
		if(!profileImg.isEmpty()) { //파일명이 비어 있지 않다면
			//첨부하려는 원본 파일명
			originFileName = profileImg.getOriginalFilename();
		...
		profileVO.setChangedName(fileName);
		profileVO.setOriginName(originFileName);
